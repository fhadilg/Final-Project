        ...
        <div id="images">
            <a href="#">
                <img class="tentanggambar img-fluid" border="0" alt="logo"
                    src="<?php echo e(asset('image/kototabang1.jpeg')); ?>" /></a>
            <a href="#" target="_blank">
                <img class="tentanggambar img-fluid" border="0" alt="logo"
                    src="<?php echo e(asset('image/kototabang2.png')); ?>" /></a>
        </div>
    </div>
    <br>
    <div class="container">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\cd\ta\resources\views/tentang.blade.php ENDPATH**/ ?>